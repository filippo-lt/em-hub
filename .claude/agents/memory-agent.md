...
description: "Extract and save memory entries from completed workflows. Use when the user says things like: 'extract memory from this', 'save to memory', 'what should I remember', 'prepare memory update'."
---
