---
name: Contractor Performance Agent
description: "Collect and analyse contractor/external developer performance metrics from GitHub and Jira. Use when the user says things like: 'contractor metrics', 'how is [dev] performing', 'dev performance report'."
---
