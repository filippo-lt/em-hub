---
name: review
description: "Draft performance reviews, feedback, and calibration materials. Use when the user says things like: 'write a review for [name]', 'draft feedback', 'prep for calibration', 'assess performance'."
user_invocable: true
---
...
If the user needs to deliver the feedback in a conversation, hand off to `/prep` with the review as context input. The prep skill will help structure the conversation.
