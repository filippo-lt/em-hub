...
- **Face AI** AI-SE pilot — Vlad currently stuck in a refactor loop; hypothesis is codebase quality is below the AI-SE viability floor
- **Screen Mirroring** + **iMote iOS** — Andre transitioning to solo SE on both; externals (Sergey, Artiom) off-boarding May 31 / June 15
- **M&A** — 5 acquired apps inbound Q3; Flutter gap unresolved
...
| # | Item | Owner | Trigger |
|---|---|---|---|
| 1 | 90-min pair session with Vlad on real refactor task | Filippo | By Tue May 12 |
| 2 | Face AI 1.2.0 ships to App Store | Vlad | Mon May 11 target |
| 3 | Vlad's new strategy chosen (A: hand-rolled refactor + AI assist / B: greenfield rebuild of image-adjust) | Filippo, post-pair | EoW May 15 |
| 4 | Half-page codebase-floor finding doc — first draft, for me only | Filippo | EoW May 15 |
...
| 13 | Vlad's new strategy delivers a named milestone (e.g., "image-adjust rebuilt with parity tests" OR "X module hand-refactored, shipping") | Vlad |
| 14 | Codebase-floor finding evolved to 1-page doc — sharable | Filippo |
...
| 20 | Phase 2 boundary finding shared with David formally (1-pager) | Filippo |
...
| 23 | AI-SE pilot has shipped Face AI 1.2.0 + one rebuild/refactor milestone | Vlad |
...
| Vlad pair reveals workflow gap that takes >1 week to fix | Pair shows fundamental AI-SE skill gap | Bring in Sergio Durban or Andrey for 2nd pair; reset timeline |
